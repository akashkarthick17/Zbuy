...
<body>
    ...
    <div class="body-container">
        ...
        <div id="article" class="article  ">
            ...
            <div class="row">
                <div class="col-xs-12  col-sm-12  col-md-12 col-lg-12  box  bootstrap-table ">
                    ...
                    <div class="box-body">
                        <div class="responsive-table">
                            <table id="table1" class="design-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td> <span class="processed span-table"> processed</span> </td>
                                        <td>123#</td>
                                        <td>Akash</td>
                                        <td>12/06/2018</td>
                                        <td>Rs. 500</td>
                                    ...
                                    <tr>
                                        <td> <span class="delivered span-table">Delivered</span> </td>
                                        <td>123#</td>
                                        <td>Akash</td>
                                        <td>12/06/2018</td>
                                        <td>Rs. 500</td>
                                    ...
                                    <tr>
                                        <td> <span class="rejected span-table"> Rejected </span> </td>
                                        <td>123#</td>
                                        <td>Akash</td>
                                        <td>12/06/2018</td>
                                        <td>Rs. 500</td>
