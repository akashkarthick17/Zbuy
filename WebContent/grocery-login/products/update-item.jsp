            ...
            <div class="row">
                ...
                <div class="col-xs-12  col-sm-12  col-md-12 col-lg-12  box  ">
                    ...
                    <div class="box-body ">
                            ...
                            <table class="text-right">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="product-id" id="product-id" value="#1234" disabled>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="product-name" id="product-name" value="coffee">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="price" id="price" value="345">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="quantity" id="quantity" value="1">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="unit  " id="unit" value="Pcs.">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                        ...
                        <div class="display-center">
                            <input type="submit" class="btn button success" name="Edit" id="edit">
                        </div>
